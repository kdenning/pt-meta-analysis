...
```{r}
pt_filter1_df <- data.frame(pt_comparison = c("pt_v_control", "pt_v_control", "pt_v_control", 
                  "pt_v_objective", "pt_v_objective", "pt_v_objective")) 

outcome_filter1_df <- data.frame(outcome_type = c("Stereotyping", "Overlap", "Interpersonal Feels",
                     "Stereotyping", "Overlap", "Interpersonal Feels"))
...
map(meta_overall1, ~filter(map2(pt_filter1_df, outcome_filter1_df, ~pt_comparison == .x & 
             outcome_type == .y)),
             .data = .x)

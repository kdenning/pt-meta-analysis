...
feels_model <- rma.mv(dunb, 
                      var_dunb,
                      mods = ~ pt_comparison,
                      random = list(~ effect_size_num | sample_number_total/outcomes_within_sample_var/conditions_within_sample_var/effect_size_num, 
...
```{r check if model is over parametized, include = FALSE}

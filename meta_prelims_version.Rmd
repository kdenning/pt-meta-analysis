...
get_I2(meta_overall1_control, meta_multi1_control)
```
...
get_I2(meta_overall1_objective, meta_multi1_objective)
```
...
get_I2(meta_stereo1, stereo_meta1_out)
```
...
get_I2(meta_stereo2, stereo_meta2)
```
...
get_I2(overlap_data, overlap_pt)
```
